...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picToolBar 
      ...
      Begin VBProjectBackUp.chameleonButton cmdAbort 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "frmMain.frx":19DC
         PICN            =   "frmMain.frx":19F8
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
         ...
         VALUE           =   0   'False
      End
      Begin VBProjectBackUp.chameleonButton cmdOpen 
         Height          =   885
         Left            =   75
         TabIndex        =   8
         ToolTipText     =   "Open a Project"
         Top             =   30
         Width           =   870
         _ExtentX        =   1535
         _ExtentY        =   1561
         ...
         MCOL            =   65280
         MPTR            =   1
         MICON           =   "frmMain.frx":26D2
         PICN            =   "frmMain.frx":26EE
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin VB.TextBox txtPath 
         ...
         Width           =   5370
      End
      Begin VBProjectBackUp.chameleonButton cmdClear 
         Height          =   885
         Left            =   1023
         TabIndex        =   9
         ...
         MCOL            =   65280
         MPTR            =   1
         MICON           =   "frmMain.frx":43F8
         PICN            =   "frmMain.frx":4414
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin VBProjectBackUp.chameleonButton cmdAbout 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "frmMain.frx":94AE
         PICN            =   "frmMain.frx":94CA
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin VBProjectBackUp.chameleonButton cmdQuit 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "frmMain.frx":99AE
         PICN            =   "frmMain.frx":99CA
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
      ...
      Begin VBProjectBackUp.chameleonButton cmdOptions 
         ...
         MCOL            =   16777215
         MPTR            =   1
         MICON           =   "frmMain.frx":9FEF
         PICN            =   "frmMain.frx":A00B
         UMCOL           =   -1  'True
         SOFT            =   -1  'True
         PICPOS          =   2
         NGREY           =   0   'False
...
Private Const C_WarnMessage As String = "The source and destination paths are the same." & vbCrLf & _
...
Private Function IsActiveMessage() As String
  ...
  Dim lngI        As Long
    ...
    '/* Is VB IDE running?
    For lngI = 7 To 4 Step -1
        If IsActive("VB" & CStr(lngI) & ".EXE") Then
            strMessage = strMessage & CStr(lngI) & ".0"
            blnIsActive = True
            Exit For
        End If
    Next lngI
    ...
    If blnIsActive Then
        strMessage = "You have selected the option to Move files and the Visual Basic " & strMessage
        strMessage = strMessage & " Development System is running." & vbNewLine & vbNewLine & "If this is the project loaded, then at the completion of the process you " & "need to close and re-open this project!" & vbNewLine & _
         vbNewLine

        IsActiveMessage = strMessage
     Else
        IsActiveMessage = vbNullString
    End If
...
Err_Proc:
    Err_Handler True, Err.Number, Err.Description, "frmMain", "IsActive"
    Err.Clear
    Resume Exit_Proc
...
Private Sub cmdStart_Click()
  ...
  Dim lngI As Long
    ...
    If Not mblnQuitCommand Then
        If mblnReLoadProject Then
            Call OpenProjectFile(False)
            If LenB(mstrActiveMessage) Then
                frmMsgBox.SMessageModal mstrActiveMessage & "Do NOT save anything when exiting!", vbExclamation
            End If
        End If
  ...
  Dim blnRefresh          As Boolean
    ...
    If mcFile.RetShortPathName(strProjectPath) = mcFile.RetShortPathName(strNewProjectPath) Then
        ...
        If Not mblnIsVBG Then
            If optMove.Value Then mstrActiveMessage = IsActiveMessage
            If frmMsgBox.SMessageModal(C_WarnMessage & mstrActiveMessage & "Do you wish to continue?", vbQuestion + vbYesNo, "WARNING", , , , Me.Width, , Me) = vbNo Then
...
Private Sub Form_Load()
  ...
  Dim strCommandLine As String
    ...
    picOptions.Visible = CBool(chkSupportDir.Value = vbUnchecked Or chkSupportFile.Value = vbUnchecked Or chkOrganize.Value = vbUnchecked Or chkDeleteEmpty.Value = vbUnchecked Or optMove.Value)
    ...
    If LenB(strCommandLine) > 2 Then
        ...
        If LenB(Dir$(strCommandLine)) Then
            mstrProjectFileName = mcFile.GetExtensionName(strCommandLine)
            If mstrProjectFileName = "vbg" Or mstrProjectFileName = "vbp" Then
                mstrProjectFileName = strCommandLine
                Call OpenProjectFile(False)
             Else
                mstrProjectFileName = vbNullString
            End If
        End If
    End If
...
Private Sub OpenProjectFile(ByVal vblnShowDialog As Boolean)
  ...
  Dim lngI          As Long
    ...
    If vblnShowDialog Then
        mcFile.VBGetOpenFileName strFileName, , , , , , "VB Project (*.vbp;*.vbg)|*.vbp;*.vbg", , , "Open" & " a VB Project", "vbp", Me.hWnd
        If strFileName = vbNullString Then GoTo Exit_Here
        mstrProjectFileName = strFileName
    End If
...
Private Sub CopyMove(ByVal vstrSPath As String, _
                     ByVal vstrDPath As String)
        ...
        If mcFile.RetFileList(vstrProjectPath & "*.*", astrFileList) Then
            ...
            For lngN = 0 To UBound(astrFileList)
                Select Case LCase$(right(astrFileList(lngN), 3))
                 Case "dsr", "dca", "frm", "frx", "cls", "bas", "gbl", "pag", "pgx", "ctl", "ctx", "res", "vbp", "vbg", "vbw", "dob", "dox"
                    '/* Do nothing
